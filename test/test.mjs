...
globalThis.QUnit ??= (await import("node:module")).createRequire(import.meta.url)('qunit-extras');
...
(function() {
  ...
  _forOwn(tests, function(fn, title) {
...
(function() {
  ...
  _forOwn(objects, function(object, key) {
  ...
  QUnit.test('should correctly detect the fastest/slowest benchmark for small sample sizes', function(assert) {
    var data = _cloneDeep(benchData),
        bench = Benchmark(data);

    var other = Benchmark(_merge(data, {
      'hz': 500,
      'stats': {
        'mean': 2,
        'sample': [2, 2, 2, 2, 2]
  ...
  QUnit.test('should correctly detect the fastest/slowest benchmark for large sample sizes', function(assert) {
    ...
    var bench = Benchmark(_merge(data, {
      'stats': {
